...
//ol.proj.get("EPSG:3857").setExtent([-8110883.466991, -4491249.341295, -8076635.800324, -4472432.174628]);
var wms_layers = [];
...
lyr_Casa_1.set('fieldLabels', {'id': 'inline label - always visible', 'Name': 'inline label - always visible', 'T_Pregunt': 'inline label - always visible', 'Porc_Co': 'inline label - always visible', 'Porc_Inc': 'inline label - always visible', 'N_Preg_Cor': 'inline label - always visible', 'N_Preg_Inc': 'inline label - always visible', 'Porc_Total': 'inline label - always visible', 'video': 'no label', });
